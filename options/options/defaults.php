            ...
            if($this->args['page_type'] == 'submenu') {
                ...
                if(true === $this->args['allow_sub_menu']) {
                    ...
                    // This is needed to prevent the top level menu item from showing in the submenu
                     add_theme_page($this->args['page_slug'], $this->args['page_title'], '', $this->args['page_cap'], $this->args['page_slug'], function($a){ return null;});
        ...
        */
        function _options_page_html() {
            ...
            if(true === $this->args['dev_mode']) {
				...
				if(isset($this->args['dev_mode_icon']) == 'image') {
