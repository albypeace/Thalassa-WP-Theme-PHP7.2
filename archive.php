            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="grid_12">
                        ...
                        <div class="title">
                            <h1><?php _e('Archive','thalassa'); ?></h1>
                        </div>
				
				
                        <div class="subtitle">
                            <span class="subtitle"> <?php $post = $posts[0]; // Hack. Set $post so that the_date() works. ?>
       <?php /* If this is a category archive */ if (is_category()) { ?>
      <?php _e('Archive for the','thalassa');?> <?php single_cat_title(); ?>  <?php _e('Category','thalassa');?>
       <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
        <?php _e('Posts Tagged','thalassa');?>  <?php single_tag_title(); ?> 
       <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
        <?php _e('Archive for','thalassa');?> <?php echo get_the_date('F jS, Y'); ?>
       <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
        <?php _e('Archive for','thalassa');?> <?php echo get_the_date('F, Y'); ?>
       <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
        <?php _e('Archive for','thalassa');?> <?php echo get_the_date('Y'); ?>
      <?php /* If this is an author archive */ } elseif (is_author()) { ?>
       <?php _e(' Author Archive','thalassa');?>
       <?php /* If this is a paged archive */ } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
        <?php _e('Blog Archives','thalassa');?>
       <?php } ?></span>
                        </div>
                    </div><!-- ..grid_12 end -->
                </div><!-- .row end -->
						...
						<?php if ( has_post_format( 'video' )) {
							...
							<?php if( has_post_format( 'image' ) !='') :?>
                                ...
                                <div class="post-content clearfix">
									...
									<?php if( get_post_meta($post->ID,'pyre_external_link',true) !='') :?>
