<?php /*
Template Name:Blog-col-2
*/ 
$th_options = get_option('thalassa_theme'); 

get_Header(); 
global $content_css, $sidebar_css, $content_width, $pagination_css;
		if($th_options['blog_type'] == 'full') {
		$content_css = 'width:100%';
		$sidebar_css = 'display:none';
		$content_width ='full thalsha-padding';
		$pagination_css = 'padding-right:30px;';
	}
	  else	if($th_options['blog_type'] == 'left') {
		$content_css = 'float:right;';
		$sidebar_css = 'float:left;';
		$pagination_css = 'float:left; padding-left:30px;';
        ...
        <section class="page-content">
            ...
            <section class="container">
                ...
                <div class="row">
                    ...
                    <ul id="blogmasonry" class="grid_9 blog-posts isotope threecols <?php echo $content_width; ?>" style="<?php echo $content_css; ?>">
				...
				<?php while ( $loop->have_posts() ) : $loop->the_post();
				 ?>
					...
					<ul>
					<li class="pagination" style="<?php echo $pagination_css; ?>">
                            <ul>
