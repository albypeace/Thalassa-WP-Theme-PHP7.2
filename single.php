<?php get_header();?>
<?php $mh_options = get_option('thalassa_theme'); ?>
<!-- #page-title start -->
            ...
            <div class="container">
                ...
                <div class="row">
					...
					<div class="title">
					 ...
					 <?php endif?>
				<?php if(!empty($th_options['blog-sin_sub-title'])):?>
						<div class="subtitle">
                            <span class="subtitle"><?php echo $th_options['blog-sin_sub-title'] ?></span>
                        </div>
				<?php else:?>
				
                        <div class="subtitle">
                            <span class="subtitle"><?php _e('Blog single post','thalassa');?></span>
                        </div>
						 <?php endif?>
                    </div><!-- ..grid_12 end -->
                </div><!-- .row end -->   
						...
						<?php if( has_post_format( 'image' ) !='') :?>
                               ...
                               <?php the_post_thumbnail('full'); ?>
                                ...
                                <article class="post-author">
                                    <h4><?php _e('About the Author','thalassa');?></h4>

                                    <?php echo get_avatar( get_the_author_meta(''), $size = '50'); ?>
