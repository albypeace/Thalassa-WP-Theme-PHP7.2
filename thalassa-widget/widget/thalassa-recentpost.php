 ...
 * @since 2.8.0
 */
class Thalassa_Recent_Posts extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'widget_recent_entries', 'description' => ( "The most recent posts on your site") );
		parent::WP_Widget('reversal-recent-posts', ('Thalassa Latest Posts'), $widget_ops);
...
register_widget('Thalassa_Recent_Posts');