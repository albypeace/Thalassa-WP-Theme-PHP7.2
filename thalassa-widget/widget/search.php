...
/* Search widget */
/*---------------------------------------------------------------------------------*/
class morpheus_Search extends WP_Widget {
	var $settings = array( 'title' );

	function __construct() {
		$widget_ops = array( 'description' => 'This is a MorpheusThemes standardized search widget.' );
		parent::WP_Widget( false, __( 'Morpheus - Search', 'morpheusthemes' ), $widget_ops );
	}
	...
	function morpheus_enforce_defaults( $instance ) {
		$defaults = $this->morpheus_get_settings();
	...
	function form( $instance ) {
		$instance = $this->morpheus_enforce_defaults( $instance );
		extract( $instance, EXTR_SKIP ); ?>
		<p>
...
register_widget( 'morpheus_Search' );
